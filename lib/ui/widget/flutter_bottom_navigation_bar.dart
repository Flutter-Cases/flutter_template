...
/// Defines the layout and behavior of a [FlutterBottomNavigationBar].
///
/// See also:
///
...
enum BottomNavigationBarType {
  /// The [FlutterBottomNavigationBar]'s [BottomNavigationBarItem]s have fixed width.
  fixed,
...
/// This example shows a [FlutterBottomNavigationBar] as it is used within a [Scaffold]
/// widget. The [FlutterBottomNavigationBar] has three [BottomNavigationBarItem]
...
class FlutterBottomNavigationBar extends StatefulWidget {
  ...
  /// The z-coordinate of this [FlutterBottomNavigationBar].
  ///
  ...
  /// The color of the [FlutterBottomNavigationBar] itself.
  ///
  ...
  @override
  _FlutterBottomNavigationBarState createState() => _FlutterBottomNavigationBarState();
}
...
class _FlutterBottomNavigationBarState extends State<FlutterBottomNavigationBar> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(FlutterBottomNavigationBar oldWidget) {
      ...
      child: Material(
        ...
        child: Container(
          ...
          child: ConstrainedBox(
            constraints: BoxConstraints(minHeight: kMinInteractiveDimension + additionalBottomPadding),
            child: CustomPaint(
...
class _Circle {
  ...
  final _FlutterBottomNavigationBarState state;
  final int index;
  final Color color;
